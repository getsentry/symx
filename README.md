...
- [`ipsw` latest release](https://github.com/blacktop/ipsw/releases/latest) / [`ipsw` Homebrew formula](https://formulae.brew.sh/formula/ipsw); sequential macOS OTA extraction requires a release containing upstream commits `d54200a66` and `3845de0a6`
...
- **Extraction commands**
  - the required `ipsw` release installed and on `PATH` (use current upstream master while developing the pending sequential macOS OTA change)
